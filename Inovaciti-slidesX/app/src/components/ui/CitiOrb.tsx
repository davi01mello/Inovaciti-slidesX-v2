...
/** Pontos uniformes na esfera via espiral de Fibonacci. Mesmos pra toda instância. */
...
export function CitiOrb({ size = 220, active = false, glow = true, className }: CitiOrbProps) {
