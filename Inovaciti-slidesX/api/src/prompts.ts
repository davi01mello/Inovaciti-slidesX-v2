...
- Frases curtas e concretas. Bullets com no máximo ~14 palavras cada.
- Use "highlight: true" em no máximo 1 a 3 palavras (ou uma frase curta) por bloco de texto — a parte mais importante daquele bloco. É renderizada em verde. Não marque a frase inteira, e não exagere na quantidade de trechos marcados.
...
1. O primeiro slide é sempre layout "cover" com o tema da apresentação. O último é sempre layout "closing".
   - Cover: título curto e forte (title-1, no máximo ~6 palavras — é tipografia display gigante), um section-label curto acima, e opcionalmente UM subtitle de uma linha. Nada de bullets na capa.
