          ...
          <div className="flex w-full flex-col items-start" style={{ gap: '3cqh' }}>
            ...
            {plan.support.map((block) => (
              <SlideText
                ...
                multiline
                ariaLabel="Subtítulo"
                spec={{ fontSize: '1.55cqw', lineHeight: 1.6, color: 'rgba(247,247,247,0.75)', minScale: 0.86 }}
          ...
          <div className="flex w-full flex-col items-center text-center" style={{ gap: '2.8cqh' }}>
            ...
            {plan.support.map((block) => (
              <SlideText
                ...
                spec={{ fontSize: '1.5cqw', lineHeight: 1.65, color: 'rgba(247,247,247,0.7)', minScale: 0.88 }}
          ...
          <div className="flex w-full flex-col items-center text-center" style={{ gap: '2.6cqh' }}>
            ...
            {plan.support.map((block) => (
              <SlideText
                ...
                multiline
                ariaLabel="Texto de apoio"
                spec={{ fontSize: '1.5cqw', lineHeight: 1.6, color: 'rgba(247,247,247,0.7)', minScale: 0.88 }}
        ...
        <div className="flex w-full flex-col items-center text-center" style={{ gap: '1.5cqh' }}>
          ...
          {plan.support.map((block) => (
            <SlideText
              ...
              multiline
              ariaLabel="Texto de apoio"
              spec={{ fontSize: '1.25cqw', lineHeight: 1.5, color: 'rgba(247,247,247,0.65)', minScale: 0.88 }}
              style={{ maxWidth: '52cqw', marginInline: 'auto' }}
            />
          ))}
        </div>
